...
import{ChooseTrack,GetTracks ,GetRoadmaps, getUserSkills, addUserSkill, completeTopic, GetSkills } from "../controllers/techUserController";
...
userRouters.get("/skills", auth, GetSkills);
